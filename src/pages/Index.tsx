      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-card/90 backdrop-blur-md border-b border-border">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2">
            <img src={logoTransparentImg} alt="Olhar Singular" className="h-8 w-auto mix-blend-multiply" loading="eager" />
      ...
      <footer className="gradient-hero border-t border-primary/20 py-10" role="contentinfo">
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-3">
              <img src={logoTransparentImg} alt="Olhar Singular" className="h-16 w-auto mix-blend-multiply" loading="lazy" />
