...
export const STYLE_PRESETS: StylePreset[] = [
  {
    ...
    textStyle: { fontSize: 12, fontFamily: "Times-Roman", bold: false, italic: false, textAlign: "justify", lineHeight: 1.5, color: "#0f172a" },
    questionSpacing: 24,
  ...
  },
  {
    ...
    textStyle: { fontSize: 11, fontFamily: "Helvetica", bold: false, italic: false, textAlign: "left", lineHeight: 1.5, color: "#0f172a" },
    questionSpacing: 20,
  ...
  },
  {
    ...
    textStyle: { fontSize: 14, fontFamily: "Helvetica", bold: true, italic: false, textAlign: "left", lineHeight: 2, color: "#0f172a" },
    questionSpacing: 32,
